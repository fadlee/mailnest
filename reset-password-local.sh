...
# Reset the local D1 admin password used by `bun run dev`.
# Usage: ./reset-password-local.sh [new-password]
...
echo "Updating local admin password..."
...
echo "Local admin password updated."
